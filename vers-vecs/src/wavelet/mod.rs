...
impl WaveletMatrix {
    ...
    fn permutation_sorting<LOOKUP: Fn(usize, usize) -> u8>(
    ...
    pub fn from_bit_vec(bit_vec: &BitVec, bits_per_element: u16) -> Self {
        ...
        Self::permutation_sorting(bits_per_element, num_elements, |element, bit| {
            bit_vec.get_unchecked(element * bits_per_element as usize + bit) as u8
        })
    }
    ...
    #[must_use]
    pub fn from_slice(sequence: &[u8], bits_per_element: u16) -> Self {
        assert!(
            bits_per_element <= 64,
